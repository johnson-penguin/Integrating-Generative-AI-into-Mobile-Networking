...
if __name__ == "__main__":
    extract_conf_segments_flat(
        conf_path="D:/Benda_benda_kuliah/.magang/TEEP/BMW/2_Probation/.BMW Github/internship/Scenario/Scenario_1/1_bbu_gnb_active_gnbs.conf",
        output_json_path="D:/Benda_benda_kuliah/.magang/TEEP/BMW/2_Probation/.BMW Github/internship/Scenario/Scenario_1/1_bbu_gnb_active_gnbs.conf.segments.json"
    )