...
conf_output_dir = "/home/oai72/Johnson/tool/scenario_gen/cu/cu_multi_param_test_conf/conf"
json_output_dir = "/home/oai72/Johnson/tool/scenario_gen/cu/cu_multi_param_test_conf/json"

os.makedirs(conf_output_dir, exist_ok=True)
os.makedirs(json_output_dir, exist_ok=True)

# === Save baseline config ===
baseline_config_path = os.path.join(conf_output_dir, "0_cu_gnb_original.conf")
...
for i in range(1, num_configs + 1):
    ...
    json_name = f"{i}_cu_gnb_random.json"
